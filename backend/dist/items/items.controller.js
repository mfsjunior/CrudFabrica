...
let ItemsController = (() => {
    let _classDecorators = [(0, common_1.Controller)('items')];
    ...
    var ItemsController = _classThis = class {
        constructor(itemsService) {
            this.itemsService = (__runInitializers(this, _instanceExtraInitializers), itemsService);
        }
        create(dto) {
